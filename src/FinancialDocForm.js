...
import { generateFinancialDoc } from "./FinancialDocService";

const FinancialDocForm = () => {
		...
		<div className="p-4 bg-white shadow-md rounded-lg">
			<div className="grid grid-cols-5 w-full mb-1 min-h-16">
				...
				<div className="col-span-2">
					<h4 className="text-2xl font-semibold pt-2">Financial Power of Attorney</h4>
				</div>
				<div></div>
				<div></div>
			</div>
