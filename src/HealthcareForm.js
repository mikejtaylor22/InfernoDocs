...
const HealthcareForm = ({ screenSize }) => {
	...
	const addNewAgent = (newAgent, type) => {
		...
		if (type === "otherContacts") setOpenOtherContact(false);
		...
		<div>
			{screenSize === "desktop" ? (
				<div className="p-4 bg-white shadow-md rounded-lg">
					<div className="grid grid-cols-3 w-full mb-1 min-h-16">
						...
						<div className="col-span-3">
							<h4 className="text-lg font-semibold pt-2 text-gray-800">
					...
					<form onSubmit={handleSubmit}>
						...
						{openOtherContact && (
							<div>
								<AgentForm addNewAgent={addNewAgent} type={"otherContacts"} />
							</div>
						)}
						...
						{formData.otherContacts.length ? (
							<div className="bg-white shadow-md rounded-lg p-6">
								<ul className="divide-y divide-gray-200">
									{formData.otherContacts.map((agent, index) => (
						...
						<div>
							<button
								...
								className="p-2 bg-green-400 mt-8 rounded-md text-white text-xs">
								{openGuardianEstate ? "Remove" : "Add"} Estate Guardian
							</button>
						</div>
				...
				<div className="p-4 bg-white shadow-md rounded-lg">
					...
					<form onSubmit={handleSubmit}>
						<div className="mt-2 pt-4">
							<p className="text-sm mb-1">Client Information</p>
						</div>
						<div className="grid grid-cols-1 gap-2 border-b border-gray-200 py-2">
							<input
								type="text"
								name="firstName"
								placeholder="First Name"
